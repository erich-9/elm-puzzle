...
Elm.Utilities.make = function (_elm) {
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var firstKey = function (_p0) {
      return $List.head($Dict.keys(_p0));
   };
   var mapWithDefault = F2(function (b,f) {
      return function (_p1) {
         return A2($Maybe.withDefault,b,A2($Maybe.map,f,_p1));
      };
   });
   var toFloatVec = function (_p2) {
      var _p3 = _p2;
      return {ctor: "_Tuple2"
             ,_0: $Basics.toFloat(_p3._0)
             ,_1: $Basics.toFloat(_p3._1)};
   };
   var dist1 = F2(function (_p5,_p4) {
      var _p6 = _p5;
      var _p7 = _p4;
      return $Basics.abs(_p6._0 - _p7._0) + $Basics.abs(_p6._1 - _p7._1);
   });
   var if$ = F3(function (x,y,z) {    return x ? y : z;});
   return _elm.Utilities.values = {_op: _op
                                  ,if$: if$
                                  ,dist1: dist1
                                  ,toFloatVec: toFloatVec
...
Elm.Main.make = function (_elm) {
   ...
   var _op = {};
   var randomInt = Elm.Native.Port.make(_elm).inbound("randomInt",
   "Int",
   function (v) {
      return typeof v === "number" && isFinite(v) && Math.floor(v) === v ? v : _U.badPort("an integer",
      v);
   });
   var join = F2(function (i,j) {
      var union = F2(function (r,s) {
         return _U.update(r,
         {level: A2($Basics.max,r.level,s.level)
         ,piece: A2($Set.union,r.piece,s.piece)});
      });
      var join$ = function (puzzle) {
         var _p0 = {ctor: "_Tuple2"
                   ,_0: A2($Dict.get,i,puzzle)
                   ,_1: A2($Dict.get,j,puzzle)};
         if (_p0.ctor === "_Tuple2" && _p0._0.ctor === "Just" && _p0._1.ctor === "Just")
         {
               return function (_p1) {
                  return A3($Dict.insert,
                  j,
                  A2(union,_p0._1._0,_p0._0._0),
                  A2($Dict.remove,i,_p1));
               }(puzzle);
            } else {
               return puzzle;
            }
      };
      return A3($Utilities.if$,_U.eq(i,j),$Basics.identity,join$);
   });
   var neighbors = function (pos) {
      var posNeighbors = function (_p2) {
         var _p3 = _p2;
         var _p5 = _p3._1;
         var _p4 = _p3._0;
         return $Set.fromList(_U.list([{ctor: "_Tuple2"
                                       ,_0: _p4 + 1
                                       ,_1: _p5}
      ...
      return A3($Set.foldl,
      F2(function (v,a) {
         return A2($Set.union,a,posNeighbors(v));
      }),
      $Set.empty,
      pos);
   };
   var movePiece = F2(function (i,_p6) {
      var _p7 = _p6;
      var movePos = function (_p8) {
         var _p9 = _p8;
         return {ctor: "_Tuple2"
                ,_0: _p9._0 + _p7._0
                ,_1: _p9._1 - _p7._1};
      ...
      i,
      $Maybe.map(function (r) {
         return _U.update(r,{pos: movePos(r.pos)});
      }));
   });
   var toTopLevel = F2(function (i,puzzle) {
      var topLevel = A3($Dict.foldl,
      $Basics.always(function (_p10) {
         return $Basics.max(function (_) {    return _.level;}(_p10));
      }),
      0,
      puzzle);
      ...
      i,
      $Maybe.map(function (r) {
         return _U.update(r,{level: topLevel + 1});
      }),
      puzzle);
   });
   var hover = $Signal.mailbox($Maybe.Nothing);
   var config = {imgSrc: "img/elm.png"
                ,imgShrinkFactor: 1
                ,imgOffsetX: 0
                ,imgOffsetY: 0
                ,cols: 3
                ...
                ,canvasHeight: 420
                ,joinDist: 10};
   var width = config.cols * config.tileWidth;
   var height = config.rows * config.tileHeight;
   var tryToJoin = F2(function (i,puzzle) {
      var g = F3(function (nbsI,j,_p11) {
         var _p12 = _p11;
         return !_U.eq(j,i) && _U.cmp(_p12.pos,
         config.joinDist) < 0 && $Basics.not($Set.isEmpty(A2($Set.intersect,
         nbsI,
         _p12.piece)));
      });
      var f = function (pos) {
         return A2($Dict.map,
         F2(function (_p13,r) {
            return _U.update(r,{pos: A2($Utilities.dist1,pos,r.pos)});
         }),
         puzzle);
      };
      var indexOfJoinCandidate = function (pp) {
         return function (_p14) {
            return $Utilities.firstKey(A2($Dict.filter,
            g(neighbors(pp.piece)),
            f(_p14)));
         }(pp.pos);
      };
      var mj = A2($Maybe.andThen,
      A2($Dict.get,i,puzzle),
      indexOfJoinCandidate);
      return A4($Utilities.mapWithDefault,
      $Basics.identity,
      join(i),
      mj,
      puzzle);
   });
   var initPos = F2(function (cr$,cr) {
      var _p15 = $Utilities.toFloatVec({ctor: "_Tuple2"
                                       ,_0: config.cols
                                       ,_1: config.rows});
      var cols = _p15._0;
      var rows = _p15._1;
      var _p16 = $Utilities.toFloatVec({ctor: "_Tuple2"
                                       ,_0: config.tileWidth
                                       ,_1: config.tileHeight});
      var w = _p16._0;
      var h = _p16._1;
      var _p17 = $Utilities.toFloatVec({ctor: "_Tuple2"
                                       ,_0: config.canvasWidth - width
                                       ,_1: config.canvasHeight - height});
      var mx = _p17._0;
      var my = _p17._1;
      ...
      var dx = _p18._0;
      var dy = _p18._1;
      var _p19 = {ctor: "_Tuple2"
                 ,_0: $Utilities.toFloatVec(cr)
                 ,_1: $Utilities.toFloatVec(cr$)};
      var c = _p19._0._0;
      var r = _p19._0._1;
      var c$ = _p19._1._0;
      var r$ = _p19._1._1;
      return {ctor: "_Tuple2"
             ,_0: (c$ - c) * w + (c$ - (cols - 1) / 2) * dx
             ,_1: (r$ - r) * h + (r$ - (rows - 1) / 2) * dy};
   });
   var imgTile = function (_p20) {
      var _p21 = _p20;
      var s = config.imgShrinkFactor;
      var _p22 = {ctor: "_Tuple2"
                 ,_0: s * config.imgOffsetX
                 ,_1: s * config.imgOffsetY};
      var xs = _p22._0;
      var ys = _p22._1;
      var _p23 = {ctor: "_Tuple2"
                 ,_0: s * config.tileWidth
                 ,_1: s * config.tileHeight};
      var ws = _p23._0;
      var hs = _p23._1;
      return A2($Graphics$Collage.scale,
      1 / s,
      $Graphics$Collage.toForm(A4($Graphics$Element.croppedImage,
      {ctor: "_Tuple2"
      ,_0: _p21._0 * ws + xs
      ,_1: (config.rows - _p21._1 - 1) * hs + ys},
      ws,
      hs,
      config.imgSrc)));
   };
   var tile = F2(function (i,cr) {
      var _p24 = {ctor: "_Tuple2"
                 ,_0: config.tileWidth
                 ,_1: config.tileHeight};
      var w = _p24._0;
      var h = _p24._1;
      var border = A2($Graphics$Collage.outlined,
      $Graphics$Collage.solid($Color.white),
      A2($Graphics$Collage.rect,
      $Basics.toFloat(w),
      $Basics.toFloat(h)));
      var f = function (hovering) {
         return A3($Utilities.if$,
         hovering,
         $Maybe.Just(i),
         $Maybe.Nothing);
      };
      ...
      function (_p25) {
         return A2($Signal.message,hover.address,f(_p25));
      },
      A3($Graphics$Collage.collage,
      w - 1,
      h - 1,
      _U.list([imgTile(cr),border])));
   });
   var pieceToForms = F3(function (i,_p26,piece) {
      var _p27 = _p26;
      var _p28 = $Utilities.toFloatVec({ctor: "_Tuple2"
                                       ,_0: width
                                       ,_1: height});
      var w = _p28._0;
      var h = _p28._1;
      var _p29 = $Utilities.toFloatVec({ctor: "_Tuple2"
                                       ,_0: config.tileWidth
                                       ,_1: config.tileHeight});
      var tw = _p29._0;
      var th = _p29._1;
      var f = F2(function (cr,a) {
         var _p30 = $Utilities.toFloatVec(cr);
         var c = _p30._0;
         var r = _p30._1;
         var pos = {ctor: "_Tuple2"
                   ,_0: (c + 0.5) * tw + _p27._0 - w / 2
                   ,_1: (r + 0.5) * th + _p27._1 - h / 2};
         return A2($List._op["::"],
         A2($Graphics$Collage.move,
         pos,
         $Graphics$Collage.toForm(A2(tile,i,cr))),
         a);
      });
      return A3($Set.foldl,f,_U.list([]),piece);
   });
   var puzzleToElement = function (puzzle) {
      var _p31 = {ctor: "_Tuple2"
                 ,_0: config.canvasWidth
                 ,_1: config.canvasHeight};
      var w = _p31._0;
      var h = _p31._1;
      var addPiece = F3(function (i,_p32,a) {
         var _p33 = _p32;
         return A3($Dict.insert,
         _p33.level,
         A3(pieceToForms,i,_p33.pos,_p33.piece),
         a);
      });
      var puzzleToForms = function (_p34) {
         return $List.concat($Dict.values(A3($Dict.foldl,
         addPiece,
         $Dict.empty,
         _p34)));
      };
      return A3($Graphics$Collage.collage,w,h,puzzleToForms(puzzle));
   };
   var shuffledIndices = function () {
      var arrGen = $Random$Array.shuffle(A2($Array.initialize,
   ...
   var initPuzzle = function () {
      var initTile = function (_p35) {
         var _p36 = _p35;
         var _p38 = _p36._1;
         var i2cr = function (i) {
            return {ctor: "_Tuple2"
                   ,_0: A2($Basics._op["%"],i,config.cols)
                   ,_1: i / config.cols | 0};
         };
         var _p37 = {ctor: "_Tuple2",_0: i2cr(_p36._0),_1: i2cr(_p38)};
         var cr = _p37._0;
         var cr$ = _p37._1;
         return {ctor: "_Tuple2"
                ,_0: _p38
                ,_1: {pos: A2(initPos,cr$,cr)
                     ,level: _p38
                     ,piece: $Set.singleton(cr)}};
      };
      return function (_p39) {
         return $Dict.fromList(A2($List.map,
         initTile,
         $Array.toIndexedList(_p39)));
      }(shuffledIndices);
   }();
   var main = function () {
      var update = F2(function (m,puzzle) {
         var _p40 = m;
         if (_p40.ctor === "Just" && _p40._0.ctor === "_Tuple2") {
               switch (_p40._0._1.ctor)
               {case "Lift": return A2(toTopLevel,_p40._0._0,puzzle);
                  case "MoveBy": return A3(movePiece,
                    _p40._0._0,
                    $Utilities.toFloatVec(_p40._0._1._0),
                    puzzle);
                  default: return A2(tryToJoin,_p40._0._0,puzzle);}
            } else {
               return puzzle;
            }
      });
      var puzzleSignal = A3($Signal.foldp,
      update,
      initPuzzle,
      A2($Drag.trackMany,$Maybe.Nothing,hover.signal));
      return A2($Signal.map,puzzleToElement,puzzleSignal);
   }();
